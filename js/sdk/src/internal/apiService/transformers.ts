...
export function nodeTypeNumberToNodeType(nodeTypeNumber: number, logger?: Logger): NodeType {
...
export function permissionsToDirectMemberRole(permissionsNumber?: number, logger?: Logger): MemberRole {
